...
| [nmrugg/stockfish.js](https://github.com/nmrugg/stockfish.js) | Stockfish chess engine compiled to WebAssembly — the WASM binary bundled in `src/main/resources/stockfish/` is built from this project (currently Stockfish 19 / single-threaded) |
